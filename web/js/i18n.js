const STR = {
  vi: {
    ...
    duplicateWorkspaceButton: "Nhân bản",
    promptDuplicateWorkspace: "Tên cho workspace nhân bản (chỉ copy workflow, không copy glossary/chương/output):",
    statusDuplicateWorkspaceError: "Lỗi nhân bản: ",
    statusDuplicatedWorkspace: "Đã tạo bản sao workspace",
  ...
  en: {
    ...
    duplicateWorkspaceButton: "Duplicate",
    promptDuplicateWorkspace: "Name for the duplicate (workflow only -- no glossary/chapters/output):",
    statusDuplicateWorkspaceError: "Duplicate failed: ",
    statusDuplicatedWorkspace: "Workspace duplicated",
